...
from database.transactionservice import get_exact_card_db, get_all_cards_monitor_db, add_new_transaction_db
...
# Вывести все переводы определённого пользователя
...
# Вывести переводы определённой карты
